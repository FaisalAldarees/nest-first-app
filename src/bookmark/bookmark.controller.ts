...
export class BookmarkController {
    ...
    @Patch(':id')
    updateBookmarkById(@GetUser('id') userId: number, @Body() editBookmarkDto: EditBookmarkDto, @Param('id', ParseIntPipe) bookmarkId: number) {
        return this.bookmarkService.updateBookmarkById(userId, editBookmarkDto, bookmarkId);
    }
